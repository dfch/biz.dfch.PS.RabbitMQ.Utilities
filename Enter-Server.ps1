...
Param (
	...
	[Uri] $Server = $biz_dfch_PS_RabbitMQ_Utilities.Server
	, 
	[Parameter(Mandatory = $false, Position = 1)]
	[int] $Port = $biz_dfch_PS_RabbitMQ_Utilities.Port
	, 
	[Parameter(Mandatory = $false, Position = 2)]
	[Uri] $VirtualHost = $biz_dfch_PS_RabbitMQ_Utilities.VirtualHost
	, 
...
try {
	...
	# N/A
	if($MaxRedirects) {
		$fReturn = $biz_dfch_PS_RabbitMQ_Utilities.MQ.Connect($Server, $Port, $VirtualHost, $Username, $Password, $MaxRedirects);
	} elseif($VirtualHost) {
		$fReturn = $biz_dfch_PS_RabbitMQ_Utilities.MQ.Connect($Server, $VirtualHost, $Username, $Password);
	} elseif($Username) {
		$fReturn = $biz_dfch_PS_RabbitMQ_Utilities.MQ.Connect($Server, $Username, $Password);
	} else {
		$fReturn = $biz_dfch_PS_RabbitMQ_Utilities.MQ.Connect();
	} # if
	
	$OutputParameter = $biz_dfch_PS_RabbitMQ_Utilities.MQ;
	# $fReturn = $true;
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCB9d7rYCLglpdKDHDU2N6vkr
# NBWgghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSqdN4LmdPQo9tDIker
# FWaanj5y5zANBgkqhkiG9w0BAQEFAASCAQCUSo31SALiwFUQqeN45j8dVBjm6fBs
# GzLFlWB9BqN9j+VN8Rp0b2GlWvNLJBbB51ei+DA/SFHBefehmoV9+Z02bKhRMFq8
# xtIpRbN4rKOfoOyZg4vbeichWhynY6Mr5B5eVK4nkxWZi/saphD+lMYuppdJXeeK
# ohxRc1O/8CKWC5AhHrSy6TmpG5h70jgZM035JPw88OyxXbexbfXqMeiG+gZSJO8e
# EtLDAVVDrtBNhueW4d/x4boIli77QI7nbs39ruIcJ1WD70nJeXWKCQEq+uqkzwDy
# D4UqWh0x44aPbcZNfqWnw6ktUJKaq1RKHezobR8QiDt7QczrjQOz6lmtoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE0MTEy
# NDA5MjgzNVowIwYJKoZIhvcNAQkEMRYEFIZw7ZTZhkVAW9HvkalCqiDqEJipMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQBgK4tXpO/Bo4QU9iM5YWA0
# ADjNHUQg4LwQzMEmTdB+Yyz7+XGZE7nXiHOhPuqgIqU7Rt31MTjTVfsMhz31cLmi
# z1Wnk2FWO9uTYI0Rm+Nd6Y8PTF2Y9iOjYksijk5+yf3mBWhYG6QPa+N+7ISMBvnP
# z9xbtPUXE1u74AajnRwVTwtQVQ8x1SgH0+YrxDfQdF4u6cE+6Hvg6pC0JhlsYWpC
# 4PPuHORlDxj3GjDYWfvvbbcTI/TIBKBG2Mj2ZqAdYlY95Jpy/PPIGarD0CGTk3t+
# RiCcX+9G2sO2yDFFUfK8VjpVBNcEfmnlo3TUaFDfHh0ZEfTvQ4CGDsa9uwTrpB0S
